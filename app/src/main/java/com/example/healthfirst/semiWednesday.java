...
public class semiWednesday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_semi_wednesday);
    ...
    private void loadPieChartData() {
        ...
        entries.add(new PieEntry(0.55f,"Vitamin K"));
        entries.add(new PieEntry(0.25f,"Carbs"));
        entries.add(new PieEntry(0.1f,"Fiber"));
        ...
        b10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(getApplicationContext(),WedSemiVegFood.class);
                startActivity(i);
